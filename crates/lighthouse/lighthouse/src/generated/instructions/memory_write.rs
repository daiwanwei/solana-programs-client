...
use crate::{generated::types::WriteType, hooked::CompactU64};
...
impl MemoryWrite {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(self.program_id, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            self.system_program,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new(self.payer, true));
        accounts.push(solana_program::instruction::AccountMeta::new(self.memory, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            self.source_account,
            false,
        ));
...
///
///   0. `[]` program_id
///   1. `[optional]` system_program (default to
...
impl<'a, 'b> MemoryWriteCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.memory.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
...
impl<'a, 'b> MemoryWriteCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let args = MemoryWriteInstructionArgs {
            ...
            memory_bump: self.instruction.memory_bump.clone().expect("memory_bump is not set"),
            write_offset: self.instruction.write_offset.clone().expect("write_offset is not set"),
            write_type: self.instruction.write_type.clone().expect("write_type is not set"),
        };
        let instruction = MemoryWriteCpi {
            ...
            source_account: self.instruction.source_account.expect("source_account is not set"),
            __args: args,
        };
