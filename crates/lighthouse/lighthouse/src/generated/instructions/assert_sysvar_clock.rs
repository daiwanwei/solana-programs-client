...
use crate::generated::types::{LogLevel, SysvarClockAssertion};
...
impl AssertSysvarClockInstructionData {
    pub fn new() -> Self { Self { discriminator: 15 } }
}
...
impl<'a, 'b> AssertSysvarClockCpi<'a, 'b> {
    pub fn new(
        ...
        Self { __program: program, __args: args }
    }
...
impl<'a, 'b> AssertSysvarClockCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction =
            AssertSysvarClockCpi { __program: self.instruction.__program, __args: args };
