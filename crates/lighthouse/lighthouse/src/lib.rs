...
pub use generated::{
    programs::{LIGHTHOUSE_ID, LIGHTHOUSE_ID as ID},
    types,
};
...
pub mod utils {
    ...
    pub fn append_instructions_to_transaction(
        ...
        let transaction = Transaction::new_unsigned(Message::new(
            &merged_ixs,
            Some(transaction.message.account_keys.first().ok_or(ClientError::EmptyTransaction)?),
        ));
    ...
    pub fn append_instructions_to_versioned_transaction(
        ...
        transaction.message.set_recent_blockhash(*transaction.message.recent_blockhash());
            ...
            modified_ixs.push(Instruction {
                ...
                accounts: instruction
                    ...
                    .map(|index| AccountMeta {
                        ...
                        is_writable: transaction.message.is_maybe_writable(*index as usize, None),
                    })
                    .collect(),
