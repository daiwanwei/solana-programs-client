...
use crate::{constants::TICK_ARRAY_SIZE, math::u256_math::*};
...
// pub fn get_tick_start_index(tick_index: i32, tick_spacing: u16) -> i32 {
//     let tick_spacing_i32 = tick_spacing as i32;
//     let tick_array_size_i32 = TICK_ARRAY_SIZE;

//     tick_index / tick_spacing_i32 / tick_array_size_i32 * tick_array_size_i32
// * tick_spacing_i32 }
