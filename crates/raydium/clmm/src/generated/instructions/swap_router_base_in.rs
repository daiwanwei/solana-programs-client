...
impl SwapRouterBaseIn {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.input_token_mint, false));
...
impl SwapRouterBaseInInstructionData {
    pub fn new() -> Self { Self { discriminator: [69, 125, 115, 218, 245, 186, 242, 196] } }
}
...
impl<'a, 'b> SwapRouterBaseInCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new(*self.input_token_mint.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
