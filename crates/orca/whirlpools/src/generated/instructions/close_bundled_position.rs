...
impl CloseBundledPosition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.receiver, false));
...
impl CloseBundledPositionInstructionData {
    pub fn new() -> Self { Self { discriminator: [41, 36, 216, 245, 27, 85, 103, 67] } }
}
...
impl<'a, 'b> CloseBundledPositionCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.receiver.key, false));
