...
impl ClosePosition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.nft_owner, true));
        accounts.push(solana_program::instruction::AccountMeta::new(self.position_nft_mint, false));
        accounts
...
impl ClosePositionInstructionData {
    pub fn new() -> Self { Self { discriminator: [123, 134, 81, 0, 49, 68, 98, 98] } }
}
...
impl<'a, 'b> ClosePositionCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(6 + remaining_accounts.len());
        accounts.push(solana_program::instruction::AccountMeta::new(*self.nft_owner.key, true));
