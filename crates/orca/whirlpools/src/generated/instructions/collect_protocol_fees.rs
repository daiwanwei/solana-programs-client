...
impl CollectProtocolFees {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new(self.token_destination_a, false));
        accounts
            .push(solana_program::instruction::AccountMeta::new(self.token_destination_b, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            self.token_program,
            false,
        ));
...
impl CollectProtocolFeesInstructionData {
    pub fn new() -> Self { Self { discriminator: [22, 67, 23, 98, 150, 178, 70, 220] } }
}
