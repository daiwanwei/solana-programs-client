...
pub struct CollectRemainingRewards {
    ...
    pub reward_vault_mint: solana_program::pubkey::Pubkey,
...
impl CollectRemainingRewards {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(self.reward_funder, true));
        accounts
...
impl CollectRemainingRewardsInstructionData {
    pub fn new() -> Self { Self { discriminator: [18, 237, 166, 197, 34, 16, 213, 144] } }
}
...
pub struct CollectRemainingRewardsBuilder {
    ...
    reward_vault_mint: Option<solana_program::pubkey::Pubkey>,
...
impl CollectRemainingRewardsBuilder {
    ...
    pub fn reward_vault_mint(
        &mut self,
        reward_vault_mint: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CollectRemainingRewards {
            ...
            reward_vault_mint: self.reward_vault_mint.expect("reward_vault_mint is not set"),
            token_program: self
                .token_program
...
pub struct CollectRemainingRewardsCpiAccounts<'a, 'b> {
    ...
    pub reward_vault_mint: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> CollectRemainingRewardsCpiBuilder<'a, 'b> {
    ...
    pub fn reward_vault_mint(
        &mut self,
        reward_vault_mint: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct CollectRemainingRewardsCpiBuilderInstruction<'a, 'b> {
    ...
    reward_vault_mint: Option<&'b solana_program::account_info::AccountInfo<'a>>,
