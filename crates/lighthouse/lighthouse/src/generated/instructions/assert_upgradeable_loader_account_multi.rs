...
use crate::{generated::types::LogLevel, hooked::UpgradeableLoaderStateAssertions};
...
impl AssertUpgradeableLoaderAccountMultiInstructionData {
    pub fn new() -> Self { Self { discriminator: 14 } }
}
...
impl<'a, 'b> AssertUpgradeableLoaderAccountMultiCpi<'a, 'b> {
    pub fn new(
        ...
        Self { __program: program, target_account: accounts.target_account, __args: args }
    }
...
impl<'a, 'b> AssertUpgradeableLoaderAccountMultiCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let args = AssertUpgradeableLoaderAccountMultiInstructionArgs {
            ...
            assertions: self.instruction.assertions.clone().expect("assertions is not set"),
        };
        let instruction = AssertUpgradeableLoaderAccountMultiCpi {
            __program: self.instruction.__program,

            target_account: self.instruction.target_account.expect("target_account is not set"),
            __args: args,
        };
