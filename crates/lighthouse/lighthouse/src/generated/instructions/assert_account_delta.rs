...
use crate::generated::types::{AccountDeltaAssertion, LogLevel};
...
impl AssertAccountDelta {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(self.account_a, false));
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(self.account_b, false));
