...
impl InitializeFeeTier {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.fee_tier, false));
        accounts.push(solana_program::instruction::AccountMeta::new(self.funder, true));
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(self.fee_authority, true));
...
impl InitializeFeeTierInstructionData {
    pub fn new() -> Self { Self { discriminator: [183, 74, 156, 160, 112, 2, 42, 30] } }
}
...
impl<'a, 'b> InitializeFeeTierCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.fee_tier.key, false));
