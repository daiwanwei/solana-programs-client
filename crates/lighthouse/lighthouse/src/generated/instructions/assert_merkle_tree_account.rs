...
use crate::generated::types::{LogLevel, MerkleTreeAssertion};
...
impl AssertMerkleTreeAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(self.root, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
...
impl AssertMerkleTreeAccountInstructionData {
    pub fn new() -> Self { Self { discriminator: 16 } }
}
...
impl AssertMerkleTreeAccountBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AssertMerkleTreeAccount {
            target_merkle_tree: self.target_merkle_tree.expect("target_merkle_tree is not set"),
...
impl<'a, 'b> AssertMerkleTreeAccountCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new_readonly(*self.root.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
...
impl<'a, 'b> AssertMerkleTreeAccountCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let args = AssertMerkleTreeAccountInstructionArgs {
            log_level: self.instruction.log_level.clone().unwrap_or(LogLevel::Silent),
            assertion: self.instruction.assertion.clone().expect("assertion is not set"),
        };
