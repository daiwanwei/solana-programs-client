...
impl UpdateRewardInfosInstructionData {
    pub fn new() -> Self { Self { discriminator: [163, 172, 224, 52, 11, 154, 106, 223] } }
}
...
impl UpdateRewardInfosBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts =
            UpdateRewardInfos { pool_state: self.pool_state.expect("pool_state is not set") };
...
impl<'a, 'b> UpdateRewardInfosCpi<'a, 'b> {
    pub fn new(
        ...
        Self { __program: program, pool_state: accounts.pool_state }
    }
