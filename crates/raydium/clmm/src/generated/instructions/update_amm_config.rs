...
impl UpdateAmmConfig {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.amm_config, false));
...
impl UpdateAmmConfigInstructionData {
    pub fn new() -> Self { Self { discriminator: [49, 60, 174, 136, 154, 28, 116, 200] } }
}
...
impl<'a, 'b> UpdateAmmConfigCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.amm_config.key, false));
