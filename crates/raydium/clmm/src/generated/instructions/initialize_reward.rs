...
impl InitializeReward {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.reward_funder, true));
        accounts
            .push(solana_program::instruction::AccountMeta::new(self.funder_token_account, false));
        accounts
        ...
        accounts
            .push(solana_program::instruction::AccountMeta::new(self.reward_token_vault, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
...
impl InitializeRewardInstructionData {
    pub fn new() -> Self { Self { discriminator: [95, 135, 192, 196, 242, 129, 230, 68] } }
}
...
///   8. `[optional]` system_program (default to
///      `11111111111111111111111111111111`)
///   9. `[optional]` rent (default to
...
impl InitializeRewardBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InitializeReward {
            ...
            reward_token_vault: self.reward_token_vault.expect("reward_token_vault is not set"),
...
impl<'a, 'b> InitializeRewardCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(10 + remaining_accounts.len());
        accounts.push(solana_program::instruction::AccountMeta::new(*self.reward_funder.key, true));
...
impl<'a, 'b> InitializeRewardCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitializeRewardCpi {
            ...
            reward_funder: self.instruction.reward_funder.expect("reward_funder is not set"),
            ...
            operation_state: self.instruction.operation_state.expect("operation_state is not set"),
