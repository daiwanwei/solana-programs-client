...
pub enum AmmV3Error {
    ...
    #[error("Account lack")]
    AccountLack = 0x1773,
    /// 6004 - Remove liquitity, collect fees owed and reward then you can close
    /// position account
    ...
    /// 6009 - The tick must be lesser than, or equal to the maximum
    /// tick(443636)
    ...
    /// 6032 - The reward tokens must contain one of pool vault mint except the
    /// last reward
    ...
    /// 6037 - Modification of emissiones is allowed within 72 hours from the
...
impl solana_program::program_error::PrintProgramError for AmmV3Error {
    fn print<E>(&self) {
        solana_program::msg!(&self.to_string());
    }
}

impl<T> solana_program::decode_error::DecodeError<T> for AmmV3Error {
