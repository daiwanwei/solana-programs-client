...
use crate::math::u256_math::U256Muldiv;
...
pub fn div_round_up(n: u128, d: u128) -> Result<u128, ErrorCode> { div_round_up_if(n, d, true) }
...
pub fn div_round_up_if_u256(
    ...
    result.try_into_u128().map_err(|_| ErrorCode::NumberDownCastError)
}
