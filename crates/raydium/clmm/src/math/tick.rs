...
/// # Arguments
/// * `tick` - Price tick
pub fn get_sqrt_price_at_tick(tick: i32) -> Result<u128, TickError> {
    let abs_tick = tick.abs() as u32;

    if abs_tick > MAX_TICK as u32 {
        return Err(TickError::TickUpperOverflow);
    }
...
pub fn get_tick_at_sqrt_price(sqrt_price_x64: u128) -> Result<i32, TickError> {
    ...
    if sqrt_price_x64 < MIN_SQRT_PRICE_X64 || sqrt_price_x64 >= MAX_SQRT_PRICE_X64 {
        return Err(TickError::SqrtPriceX64Overflow { sqrt_price_x64 });
    }
