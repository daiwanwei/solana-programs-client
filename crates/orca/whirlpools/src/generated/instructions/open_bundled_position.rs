...
impl OpenBundledPosition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.bundled_position, false));
        accounts.push(solana_program::instruction::AccountMeta::new(self.position_bundle, false));
...
impl OpenBundledPositionInstructionData {
    pub fn new() -> Self { Self { discriminator: [169, 113, 126, 171, 213, 172, 212, 49] } }
}
...
impl<'a, 'b> OpenBundledPositionCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(8 + remaining_accounts.len());
        accounts
            .push(solana_program::instruction::AccountMeta::new(*self.bundled_position.key, false));
        accounts
            .push(solana_program::instruction::AccountMeta::new(*self.position_bundle.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
